...
class GBN(torch.nn.Module):
    ...
    def __init__(self, input_dim, virtual_batch_size=128, momentum=0.01):
        ...
        self.bn = BatchNorm1d(self.input_dim, momentum=momentum,track_running_stats=track_running_stats)
        print("track_running_stats",track_running_stats)
...
class TabNetNoEmbeddings(torch.nn.Module):
    def __init__(self, input_dim, output_dim,
        ...
        self.initial_bn = BatchNorm1d(self.input_dim, momentum=0.01,track_running_stats=track_running_stats)
